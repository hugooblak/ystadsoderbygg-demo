...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'ystadsoderbygg-leads' ),
				'storm'       => __( 'Storm or hail damage', 'ystadsoderbygg-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'ystadsoderbygg-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'ystadsoderbygg-leads' ),
				'not-sure'    => __( 'Vet inte än', 'ystadsoderbygg-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'ystadsoderbygg-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'ystadsoderbygg-leads' ),
				'research' => __( 'Jag kollar bara priser', 'ystadsoderbygg-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'ystadsoderbygg-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'ystadsoderbygg-leads' ),
		'contacted' => __( 'Kontaktad', 'ystadsoderbygg-leads' ),
		'quoted'    => __( 'Quote sent', 'ystadsoderbygg-leads' ),
		'won'       => __( 'Won', 'ystadsoderbygg-leads' ),
		'lost'      => __( 'Lost', 'ystadsoderbygg-leads' ),
		'spam'      => __( 'Misstänkt spam', 'ystadsoderbygg-leads' ),
	);
}
